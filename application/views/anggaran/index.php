							...
							<div class="card-body d-flex align-items-center p-3">
								...
								<div>
									<div class="d-flex justify-content-between">
										<div class="text-muted small fw-bold fs-4">Total Pengguna</div>
									...
									<div class="m-0 fw-bold fs-1">1,231</div>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="card-body d-flex align-items-center p-3">
								<div class="bg-danger p-3 rounded me-3">
									<svg width="40" height="40" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M25.7367 3.12507C31.0429 3.12507 36.6703 7.5945 36.6703 10.9304V18.739C36.6703 21.7445 35.4203 27.4945 32.0679 30.1343C31.6475 30.4653 31.3191 30.8986 31.1142 31.3929C30.9092 31.8871 30.8347 32.4257 30.8976 32.9571C31.0257 34.0391 31.7078 34.9742 32.6968 35.429L46.2953 41.8774C46.4015 41.9258 47.5984 42.1266 47.5984 43.7985L47.5999 46.8485L3.87495 46.8508V43.6798C3.87495 42.4376 4.80698 42.0477 5.17964 41.8758L18.9015 35.4C19.8858 34.9485 20.5648 34.0172 20.6968 32.943C20.8296 31.8688 20.396 30.8024 19.5515 30.125C16.3054 27.5188 14.7929 21.7899 14.7929 18.739V10.9304C14.7937 7.66642 20.4773 3.12507 25.7367 3.12507ZM25.7367 -3.05176e-05C18.8367 -3.05176e-05 11.668 5.75866 11.668 10.9305V18.7391C11.668 22.1508 13.225 29.0539 17.5953 32.5617L3.87266 39.0383C3.87266 39.0383 0.75 40.4297 0.75 42.1617V46.8508C0.75 48.5766 2.14844 49.9742 3.87261 49.9742H47.6007C49.3265 49.9742 50.7242 48.5766 50.7242 46.8508V42.1617C50.7242 40.3258 47.6007 39.0383 47.6007 39.0383L34.0023 32.5899C38.3312 29.1828 39.796 22.4898 39.796 18.739V10.9304C39.796 5.75856 32.6359 1.83105e-05 25.7367 1.83105e-05V-3.05176e-05Z" fill="white" />
									</svg>
								</div>
								<div>
									<div class="text-muted small fw-bold fs-4">Pengguna Aktif</div>
									<div class="m-0 fw-bold fs-1">23</div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="card" style="border-radius: 10px; overflow: hidden;">
							<div class="card-body d-flex align-items-center p-3">
								...
								<div>
									<div class="text-muted small fw-bold fs-4">Jumlah Laporan</div>
									<div class="m-0 fw-bold fs-1">4</div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="card" style="border-radius: 10px; overflow: hidden;">
							<div class="card-body d-flex align-items-center p-3">
								...
								<div>
									<div class="text-muted small fw-bold fs-4">Jumlah Modul</div>
									<div class="m-0 fw-bold fs-1">4</div>
								</div>
							</div>
						</div>
